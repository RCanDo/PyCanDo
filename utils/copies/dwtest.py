...
title: Durbin-Watson test p value calculation
subtitle:
version: 1.0
type: submodule
keywords: [Durbin-Watson test, p-values]
description: |
    Durbin-Watson statistic and p-value.
    Free to use, copy, share, and modify.
    Implemented by Dmytro Makogon. 
    Inspired by lmtest/R/dwtest.R
remarks:    
todo:
sources:
    - link: https://github.com/dima-quant/dwtest
      date: 2020-09-04
      usage: copy
file:
    usage:
        ...
        terminal: True
    name: dwtest.py
    path: ~/Projects/Python/RCanDo/copies/
    date: 2020-04-19
    authors:
        - nick:
          fullname: Dmytro Makogon
          email:
"""
...
def durbin_watson_test(res, X, tail='both', method='Pan', matrix_inverse = False, n = 15):
    """
